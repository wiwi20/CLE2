...
<div class="container">
    <div class="row inleiding">
        <div class="col-sm-4">
            <h4>Reserveren</h4>
            <p>Een tafel reserveren kan nu online!. Hieronder ziet u een reserveringsformulier.
                Wilt u gezellig met uw vrienden of uw familie uiteten bij ons en wilt u niet wachten op lange rijen?
                Dat kan nu! Vul het reserveringsformulier in en binnen enkele minuten krijgt u een bevestigingsmail terug.
                <br>LET OP: reserveren kan vanaf minimaal 4 personen tot maximaal 8 personen.
            </p>
            <a href="#res"> <button type="button" class="btn btn-dark">Nu reserveren</button></a>
        </div>
        <div class="col-sm-4">
            <h4>Over ons</h4>
            <p>Zoekt u een restaurant om uit eten te gaan met uw familie en uw vrienden maar u weet nog niet zeker of dit bij u past?
                Bekijk onze "over-ons" pagina voor meer informatie over het restaurant. Past dit bij u? Reserveer snel hieronder, want vol = vol.
            </p>
            <a href="over.html"><button type="button" class="btn btn-dark">Over ons pagina</button></a>
        </div>
        <div class="col-sm-4">
            <h4>Contact</h4>
            <p id="res">Heeft u nog vragen? Weet u niet hoe u moet reserveren? Neem snel contact met ons op via email. Binnen 2 werkdagen wordt uw vraag beantwoord.
                U kunt ons ook bellen op 010-7537433. Ga naar de contactpagina voor meer gegevens over het restaurant zoals onze openingstijden en de locatie.
            </p>
...
<!--    <h2 >Tafel reserveren</h2>-->
    <h2>Tafel reserveren / 预订餐桌</h2>
    <p>*Geen eror na het verzenden? dan is uw reservering binnen. U wordt eventueel gebeld of gemaild voor wijzigingen.
        Let op: reserveren kan tussen de 17:00 uur - 20:00 uur en max 4-8 personen.<br>
   </p>
        ...
        <div class="col-lg-6 col-sm-12">
            ...
            if (isset($_POST['submit'])) {
                ...
                if (empty($errors)) {
                    ...
                    if ($result){
//                        $subject = "Cafetaria-Lunchroom Dinges";
//                        $body = 'Leuk dat u komt eten!, Uw reservering is binnen! De datum is '. $datum .' De tijd is ' . $tijd .  '.';
//                        $headers = "From: 0980313@hr.nl";
//
//                        if (mail($email, $subject, $body, $headers)) {
                            echo "<p style='color:red;'>"."Uw reservering is binnen(您的预订已收到).";
                        } else {
                            echo "Uw reservering is niet binnen.";
                        }
...
<div class="footer-main bg-dark py-5 small">
    <div class="footer container">
        <p>© Cafetaria-Lunchroom Dinges 2020</p>
